...
public class NoneAcceptCommand : ModuleBase<SocketCommandContext>
{
    /// <summary>
    ...
    public async Task ExecuteAsync()
    {
        ...
        Facade.Instance.LeaveInstance(displayName);
        await ReplyAsync("No se han aceptados las condiciones. No hay batalla!");
    }
}